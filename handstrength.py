...
#			return self.deck.dealFlop() + self.deck.dealTurn() + self.deck.dealRiver()
	...
	def maxOdds():
		maxOdds = 0
		maxOdds = self.player1Odds()
		if(self.player2Odds() > baseOdds):
			maxOdds = self.player2Odds
		if(self.player3Odds() > baseOdds):
			maxOdds = self.player3Odds
		if(self.player4Odds() > baseOdds):
			maxOdds = self.player4Odds
		if(self.player5Odds() > baseOdds):
			maxOdds = self.player5Odds
		return maxOdds
	def minOdds():
		minOdds = 0
		minOdds = self.player1Odds()
		if(self.player2Odds() < baseOdds):
			minOdds = self.player2Odds
		if(self.player3Odds() < baseOdds):
			minOdds = self.player3Odds
		if(self.player4Odds() < baseOdds):
			minOdds = self.player4Odds
		if(self.player5Odds() < baseOdds):
			minOdds = self.player5Odds
		return minOdds
